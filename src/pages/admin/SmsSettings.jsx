...
const DEFAULTS = {
  ...
  defaultTemplate: "Hello {name}, your repayment of {amount} is due on {date}."
};

export default function SmsSettings() {
  const { data, setData, loading, saving, error, success, save } =
    useSettingsResource(SettingsAPI.getSms, SettingsAPI.saveSms, DEFAULTS);
  ...
  return (
    <div className="space-y-4">
      <header className="bg-white dark:bg-slate-900 border rounded-2xl p-4">
        ...
        <p className="text-sm text-slate-500">Configure SMS gateway and defaults.</p>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) => setData({ ...data, defaultTemplate: e.target.value })}
            />
          </div>
        </div>
