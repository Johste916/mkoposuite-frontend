    ...
    <div className="p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Select borrower, configure product & terms, then attach guarantors and documents.</p>
        </div>
      ...
      <form onSubmit={onSubmit} className="grid grid-cols-1 xl:grid-cols-3 gap-6 relative">
        {/* LEFT (2/3): borrower + product + terms + interest + fees + spouse */}
