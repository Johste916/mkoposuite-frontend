            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <Text
                  ...
                  onChange={(v) => setForm((s) => ({ ...s, employeeCode: v }))}
                />
              </div>
            </div>
    ...
    <label className="block">
      ...
      <input
        className={`mt-1 w-full border rounded-lg px-3 py-2 outline-none ${
          readOnly ? "bg-gray-50" : "focus:ring-2 focus:ring-indigo-200"
        }`}
        type={type}
        value={value ?? ""}
      ...
      />
      {helper && (
        <span className="block mt-1 text-[11px] text-slate-500">{helper}</span>
      )}
    </label>
  );
}
