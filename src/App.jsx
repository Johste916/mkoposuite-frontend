...
/* ✅ NEW: Import your global theme (tokens + bold theme block) */
...
// SidebarLayout lives in src/components
...
function App() {
  return (
    <ThemeProvider>
      {/* ✅ NEW: wrap the whole app so bold/high-contrast styles apply globally */}
      <div className="app-theme-bold">
